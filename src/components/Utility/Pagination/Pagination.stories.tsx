...
function Default() {
    ...
    const handleChangeFilter = React.useCallback((page: number, pageSize?: number) => {
      setFilter({
        ...filter,
    ...
    return <div style={{margin: '10px', padding: '10px', width: '500px', background: '#fff', height: '300px'}}>
